...
let chats = [];
let activeChat = null;
let webSearchEnabled = true; // Always enabled now
...
let chatContainer, welcomeScreen, chatHistory, questionInput, submitBtn, newChatBtn, 
    autocompleteContainer, suggestionCards, clearChatsBtn, notification;
...
function setupEventListeners() {
    ...
    clearChatsBtn.addEventListener('click', clearAllConversations);
